...
// React 19 스타일: ref를 일반 prop으로 처리
const TooltipWrapper = ({
  children,
  innerRef, // ref → innerRef로 변경
}: {
  children: React.ReactNode;
  innerRef?: React.RefObject<HTMLSpanElement> | ((instance: HTMLSpanElement | null) => void) | null;
}) => {
  return <span ref={innerRef}>{children}</span>;
};
