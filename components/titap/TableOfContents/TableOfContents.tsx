          ...
          <div className="flex flex-col gap-1">
            {content.map((item) => (
              <a
                key={item.id}
                className={cn(
                  "block font-medium text-neutral-500 dark:text-neutral-300 p-1 rounded bg-black/10 text-sm hover:text-neutral-800 transition-all hover:bg-black/5 truncate w-full",
                  item.isActive &&
